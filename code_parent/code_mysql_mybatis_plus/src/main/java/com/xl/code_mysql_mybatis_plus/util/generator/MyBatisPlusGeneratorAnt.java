package com.xl.code_mysql_mybatis_plus.util.generator;
...
//        String projectPath = System.getProperty("D:\\project\\java\\wxl\\code_parent\\code_mysql_mybatis_plus");
        System.out.println(projectPath+"\\code_mysql_mybatis_plus");
        // 自定义需要填充的字段
...
//        tableFillList.add(sysUpdateBy);
        ...
        dsConfig.setDbType(DbType.MYSQL)
                ...
                .setUrl("jdbc:mysql://192.168.20.150:13306/wxl?useUnicode=true&characterEncoding=UTF-8&useSSL=false")
                .setUsername("root")
                .setPassword("123456")
...
//                .setDbColumnUnderline(true)
        ...
        pkConfig.setParent("com.xl.code_mysql_mybatis_plus")
//                .dao
                .setMapper("dao")
//                servcie
                .setService("service")
